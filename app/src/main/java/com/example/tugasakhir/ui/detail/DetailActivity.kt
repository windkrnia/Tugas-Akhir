package com.example.tugasakhir.ui.detail

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.tugasakhir.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    private fun getDetailTvShow(data: TvShowResponse) {
        binding.apply {
            ...
            tvDesc.text = if (data.desc.isNullOrBlank()) "No Description" else data.desc
